export const en = {
  ...
  'login.codeSubtitle': 'We sent a 6-digit code to {email}.',
  'login.codePlaceholder': '6-digit code',
  'login.sendCode': 'Send code',
  'login.sendingCode': 'Sending code...',
  'login.emailRequired': 'Enter your email.',
  'login.codeRequired': 'Enter the 6-digit code.',
  'login.verifyCode': 'Continue',
  'login.verifyingCode': 'Verifying...',
  'login.resendCode': 'Send the code again',
  'login.resendCodeIn': 'Resend in {seconds}s',
  'login.codeResent': 'Code sent again.',
  'login.changeEmail': 'Change email',
  'login.usePassword': 'I already have a password',
  'login.passwordOnlyHint': 'Only for accounts that have set a password.',
  'login.useCode': 'Sign in with a code',
  'login.setPasswordTitle': 'Set a password',
  'login.setPasswordSubtitle': 'You can set a password to sign in faster next time, or skip this step.',
  'login.newPasswordPlaceholder': 'New password',
  'login.savePassword': 'Save password',
  'login.savingPassword': 'Saving...',
  'login.skipForNow': 'Skip',
  'login.passwordSaved': 'Password saved.',
  ...
  'userMenu.changePhotoTitle': 'Profile photo',
  'userMenu.takePhoto': 'Take photo',
  'userMenu.choosePhoto': 'Choose photo',
  'userMenu.removePhoto': 'Remove photo',
  'userMenu.galleryPermissionDenied': 'Allow access to your photos to set a profile picture.',
  'userMenu.cameraPermissionDenied': 'Allow access to your camera to take a profile picture.',
  ...
  'dashboard.trend': 'Compared to last month',
  ...
  'budget.unallocated': 'Unallocated: {amount}',
  'budget.overAllocatedBy': 'Over by {amount}',
  'budget.notDefined': 'Not defined',
  ...
  'itemAssignPicker.percentageMode': 'Percentage',
  'itemAssignPicker.restOfGroup': 'Rest of the group',
  'itemAssignPicker.sharedInfo': 'The remaining {remaining} of {total} splits evenly with the rest of the group.',
  'itemAssignPicker.sharedInfoPercent': 'The remaining {percent}% splits evenly with the rest of the group.',
  ...
  'manualInvoice.noItems': 'Add at least one item.',
  'manualInvoice.emptyItems': 'No items yet.',
  'manualInvoice.tapToEdit': 'Tap an item to edit it.',
  'itemEditor.addTitle': 'Add item',
  'itemEditor.editTitle': 'Edit item',
  'itemEditor.namePlaceholder': 'Item name',
  'itemEditor.priceLabel': 'Unit price',
  'itemEditor.categoryLabel': 'Category',
  'itemEditor.nameRequired': 'Enter the item name.',
  'itemEditor.quantityRequired': 'The quantity must be greater than zero.',
  'itemEditor.priceRequired': 'Enter the price.',
  ...
  'invoiceReceipt.priceColumn': 'Price/unit',
  'invoiceReceipt.totalColumn': 'Total',
