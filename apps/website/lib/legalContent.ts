...
export const LEGAL_TITLES: Record<'en' | 'sq', Record<LegalDocType, string>> = {
  en: { privacy: 'Privacy Policy', terms: 'Terms of Service' },
  sq: { privacy: 'Politika e Privatësisë', terms: 'Kushtet e Përdorimit' },
};

export const LEGAL_UPDATED: Record<'en' | 'sq', string> = {
  en: 'Last updated: July 2026',
  sq: 'Përditësuar së fundmi: Korrik 2026',
};

export const PRIVACY_SECTIONS_EN: Section[] = [
  {
...
export const PRIVACY_SECTIONS_SQ: Section[] = [
  {
    heading: '1. Hyrje',
...
export const TERMS_SECTIONS_EN: Section[] = [
  {
...
export const TERMS_SECTIONS_SQ: Section[] = [
  {
...
export function getLegalSections(type: LegalDocType, language: 'en' | 'sq'): Section[] {
  if (type === 'privacy') {
    return language === 'en' ? PRIVACY_SECTIONS_EN : PRIVACY_SECTIONS_SQ;
  }
  return language === 'en' ? TERMS_SECTIONS_EN : TERMS_SECTIONS_SQ;
}
